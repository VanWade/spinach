...
class asset(models.Model):
    ...
    system_user = models.ForeignKey(to="system_users", to_field='id', on_delete=models.SET_NULL, null=True,
                                    verbose_name='登陆用户', blank=True)
    data_center = models.ForeignKey(to="data_centers", to_field='id', on_delete=models.SET_NULL, null=True,
                                    verbose_name='数据中心')
    ...
    file = models.FileField(upload_to='assets/%Y%m%d{}'.format(random.randint(0, 99999)), verbose_name="文件", null=True,
